								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/<?php echo $row_sanpham['sanpham_image'] ?>.jpg" alt="">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
												...
												<del><?php echo number_format($row_sanpham['sanpham_giakhuyenmai']).'vnd' ?></del>
											</div>
						...
						?>
							<ul>
								<li>
									...
									<span class="span"><a href="danhmucsanpham.php?i=<?php echo $row_category_sidebar['category_id'] ?>"><?php echo $row_category_sidebar['category_name'] ?></a></span>
								</li>
							</ul>
						<?php } ?>
						</div>
								...
								?>
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="images/<?php echo $row_product_sidebar['sanpham_image'] ?>.jpg" alt="" class="img-fluid">
										</div>
