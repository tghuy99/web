					...
					<div class="grid images_3_of_2">
						<div class="flexslider">
							<ul class="slides">
								...
								<li data-thumb="images/<?php echo $row_chitiet['sanpham_image'] ?>.jpg">
									<div class="thumb-image">
										<img src="images/<?php echo $row_chitiet['sanpham_image'] ?>.jpg" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
